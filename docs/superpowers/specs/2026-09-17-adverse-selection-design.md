...
| Zeilen können Minuten nach ihrem Zeitstempel erscheinen (RFQ-Maker-Zeile bis ~300 s vor der Taker-Zeile) | Stichtag muss ≥ 15 min zurückliegen; zwischengespeicherte Fenster werden nur wiederverwendet, wenn sie ≥ 15 min nach Fensterende geladen wurden |
